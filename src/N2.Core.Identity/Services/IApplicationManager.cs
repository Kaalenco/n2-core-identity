...
public interface IApplicationManager {
    ...
    Task<ICommandResponse> CreateAsync(Guid tenantId, [NotNull] ApplicationDefinition application, CancellationToken token);

    /// <summary>Deletes a tenant and removes all user-tenant associations.</summary>
    /// <param name="tenantId">The tenant to which the application belongs.</param>
    /// <param name="application">The application to delete.</param>
    /// <param name="token">Cancellation token.</param>
    Task<ICommandResponse> DeleteAsync(Guid tenantId, [NotNull] ApplicationDefinition application, CancellationToken token);
    ...
    /// <param name="token">Cancellation token.</param>
    Task<ICommandResponse> UpdateAsync(Guid tenantId, [NotNull] ApplicationDefinition application, CancellationToken token);
    ...
    Task<ApplicationDefinition?> FindByIdAsync(Guid tenantId, Guid applicationId, CancellationToken token);
    ...
    Task<ICommandResponse> LockAsync(Guid tenantId, [NotNull] ApplicationDefinition application, CancellationToken token);
    /// <summary>Unlocks a previously locked application.</summary>
    Task<ICommandResponse> UnlockAsync(Guid tenantId, [NotNull] ApplicationDefinition application, CancellationToken token);
