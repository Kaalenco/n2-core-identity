...
public sealed class JwtSettings {
    public const int DefaultRefreshTokenExpirationInMinutes = 1440; // 24 hours
    ...
    public int RefreshTokenExpirationInMinutes { get; set; } = DefaultRefreshTokenExpirationInMinutes;
