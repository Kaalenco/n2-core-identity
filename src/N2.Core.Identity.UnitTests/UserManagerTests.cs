...
public class N2UserManagerTests {
    ...
    public async Task TestConcurrentUserCreation_ShouldSerializeOperations() {
        ...
        // NOTE: EF Core InMemory provider does NOT enforce unique constraints
        // The NonDisposingWrapper serializes all operations with a semaphore,
        // ensuring thread-safe access, but InMemory allows duplicate entries.
        // In production with SQL Server, unique constraints would prevent duplicates.
